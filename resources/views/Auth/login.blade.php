...
<head>
    ...
    <style>
        body {
          ...
          background: 
            radial-gradient(circle at 80% 20%, #e0eaff 0%, transparent 55%),
            radial-gradient(circle at 20% 80%, #c4d6ff 0%, transparent 50%),  #fdfdfc;
        }
    </style>
</head>
...
<body class="bg-[#FDFDFC] flex items-center justify-center min-h-screen p-6">
    ...
    <!-- Input gambar Logo Nexus -->
        <div class="flex flex-col items-center mb-8">
            <div class="text-center" mb-4>
                <img src="{{ asset('storage/images/Nexus.png') }}" alt="nexus-logo" width="150">
            </div>
        </div>
